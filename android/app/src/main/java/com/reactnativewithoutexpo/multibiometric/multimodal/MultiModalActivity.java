...
import com.reactnativewithoutexpo.multibiometric.*;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imageFace.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				Intent faceActivity = new Intent(MultiModalActivity.this, com.reactnativewithoutexpo.multibiometric.multimodal.FaceActivity.class);
		...
		imageFinger.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent fingerActivity = new Intent(MultiModalActivity.this, com.reactnativewithoutexpo.multibiometric.multimodal.FingerActivity.class);
...
//		}
		...
		if (itemId == R.id.action_clear_db) {
			new AlertDialog.Builder(this)
					...
					.show();
		} else if (itemId == R.id.action_view_db) {
			showDatabase();
			...
			startActivity(new Intent(this, MultimodalPreferences.class));
		} else if (itemId == R.id.action_connection) {
			startActivity(new Intent(this, ConnectionPreferences.class));
		}
		return true;
	}
