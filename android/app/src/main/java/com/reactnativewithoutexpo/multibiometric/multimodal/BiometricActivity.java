...
import com.reactnativewithoutexpo.multibiometric.view.EnrollmentDialogFragment.EnrollmentDialogListener;
import com.reactnativewithoutexpo.multibiometric.view.SubjectListFragment;
import com.reactnativewithoutexpo.multibiometric.view.SubjectListFragment.SubjectSelectionListener;
...
//		}
		...
		if (itemId == R.id.action_preferences) {
			startActivity(new Intent(this, getPreferences()));
		} else if (itemId == R.id.action_database) {
			Bundle bundle = new Bundle();
			bundle.putInt(EXTRA_REQUEST_CODE, DATABASE_REQUEST_CODE);
